...
- (MDHorizontalListViewCell *)_loadCellAtIndex:(NSInteger)index {
...
- (void)_prepareToSelectCellAtIndex:(NSInteger)index animated:(BOOL)animated{
...
- (void)_selectCellAtIndex:(NSInteger)index animated:(BOOL)animated {
